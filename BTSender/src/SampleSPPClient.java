...
/**
* A simple class that sends a single TXT file via Bluetooth connection.
*/
public class SampleSPPClient implements DiscoveryListener{
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("suuuuuuuuuup");
        //display local device address and name
        LocalDevice localDevice = LocalDevice.getLocalDevice();
        System.out.println("suuuuuuuuuup bro");
        ...
        connectionURL = "btspp://001B10001C91:3";
